...
label = Label(windows, textvariable=equation_label, font=("consolas",20), bg="white",width=24,height=2)
label.pack()
...
clears = Button(windows, text="Clear", height=4, width=9, font=35,command=clear)
clears.pack()
windows.mainloop()